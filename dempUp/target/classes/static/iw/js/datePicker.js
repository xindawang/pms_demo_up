...
(function(ja) {
    var w, l, r = function(a, b) {
        if ("function" === typeof document.addEventListener || d.isIE8()) {
            ...
            for (q = 7; q--;) v.push(p.format(k.columnHeaderFormat)), p.add("days", 1);
            F(f);
            if ("object" === typeof k.subscribe)
                for (q in k.subscribe) k.subscribe.hasOwnProperty(q) && f.subscribe(q, k.subscribe[q]);
            f._sel = [];
            k.selected && f.setSelected(k.selected, !1);
            u = k.viewStartDate ? l(k.viewStartDate, k.format) : 0 < f._sel.length ? l(f._sel[0]) : l();
            f.viewStartDate = u.date(1);
            (u = {
                past: k.months - 1,
            ...
            if ("function" === typeof k.blackout) f.blackout = k.blackout;
                ...
                f.blackout = function(a) {
                    ...
                    for (var e = C.length; e--;)
                        if (C[e].startOf("day").yearDay() === a) return !0;
                    return !1
                }
            ...
            for (u = Math.max(k.months, 1); u--;) {
                ...
                q = 0;
                do D = d.make("span", {}, B), D.innerHTML = v[q]; while (7 >
                    ++q);
                B = d.make("div", {
                    "class": g.days
                }, m);
                ...
                }, B), m.push(w)), d.make("span", {}, w)) : m.push(d.make("span", {}, B)); while (42 > ++q);
                r.push({
                    caption: p,
                    days: m
                });
            ...
            f.draw();
            d.addEvent(e, "mousedown", function(a, e) {
                var b;
    ...
    r.prototype = {
            ...
            switch (this.settings.mode) {
                ...
                case "multiple":
                    for (b = this._sel.length; b--;)
                        if (this._sel[b].startOf("day").yearDay() === a) return !0;
                    return !1;
                default:
        ...
        setSelected: function(a, b) {
            ...
            for (e = d.length; e--;) this.addSelected(d[e], !1);
            !1 !== b && (d[0] && (this.viewStartDate = l(d[0], this.settings.format)), this.draw())
        },
        ...
        removeSelected: function(a, b) {
            ...
            for (var e = this._sel.length; e--;)
                if (this._sel[e].startOf("day").yearDay() === a.startOf("day").yearDay()) return this._sel.splice(e, 1), this.publish("change", this, [a]), !1 !== b && this.draw(), !0;
            return !1
        },
        draw: function() {
    ...
    var z = function(a, b, e) {
        ...
        var f = 0,
            g;
        do a[f] && (g = l(a[f], e).hours(12), g.isValid() && n.push(g)); while (++f < b);
        return n
    };
    window.Kalendae = r;
    var d = r.util = {
        ...
        make: function(a, b, e) {
            ...
            if (b)
                for (d in b) b.hasOwnProperty(d) && a.setAttribute(d, b[d]);
            e && e.appendChild(a);
            return a
        },
        ...
        addEvent: function(a, b, e) {
            var d = function(b) {
                b = b || window.event;
                var d = e.apply(a, [b, b.target || b.srcElement]);
                !1 === d && (b.preventDefault ? b.preventDefault() : (b.returnValue = !1, b.cancelBubble = !0));
                return d
            };
        ...
        addClassName: function(a, b) {
            (a = d.$(a)) && !d.hasClassName(a, b) && (a.className += (a.className ? " " : "") + b)
        },
        ...
        getPosition: function(a, b) {
            var e = a.offsetLeft,
                ...
                f = {};
            if (!b)
                for (; a = a.offsetParent;) e += a.offsetLeft,
                    d += a.offsetTop;
            f[0] = f.left = e;
            f[1] = f.top = d;
            return f
        ...
        merge: function() {
            for (var a = !0 === arguments[0], b = {}, e = a ? 1 : 0; e < arguments.length; e++) {
                var d = b,
                    f = arguments[e];
                if ("object" === typeof f) {
                    var g = void 0;
    ...
    "function" === typeof document.addEventListener && r.util.domReady(function() {
        for (var a = d.$$(".auto-kal"), b = a.length, e, n; b--;) e = a[b], n = e.getAttribute("data-kal"), n = null == n || "" == n ? {} : (new Function("return {" + n + "};"))(), "INPUT" === e.tagName ? new r.Input(e, n) : new r(d.merge(n, {
            attachTo: e
        }))
    });
    r.Input = function(a, b) {
        if ("function" === typeof document.addEventListener || d.isIE8()) {
            ...
            f.closeButton && (f = d.make("a", {
                "class": l.closeButton
            }, k.container), d.addEvent(f, "click", function() {
                e.blur()
            }));
            ...
            this._events.containerMouseDown = d.addEvent(n, "mousedown", function(a, b) {
                p = !0
            });
            this._events.documentMousedown = d.addEvent(window.document, "mousedown", function(a, b) {
                p = !1
            });
            this._events.inputFocus = d.addEvent(e, "focus", function() {
                g = !0;
                k.setSelected(this.value);
                g = !1;
                k.show()
            });
            this._events.inputBlur = d.addEvent(e, "blur", function() {
                p && d.isIE8() ? (p = !1, e.focus()) : k.hide()
            });
            this._events.inputKeyup = d.addEvent(e, "keyup", function(a) {
                g = !0;
                k.setSelected(this.value);
                g = !1
            });
            (l = d.scrollContainer(e)) && d.addEvent(l, "scroll", function(a) {
                e.blur()
            });
    ...
    r.Input.prototype = d.merge(r.prototype, {
        defaults: d.merge(r.prototype.defaults, {
			// zixiaojun change the output dateformat.
            format: "YYYY-MM-DD",
            side: "bottom",
            closeButton: !0,
            offsetLeft: 0,
        ...
        show: function() {
            ...
            switch (g.side) {
                ...
                case "top":
                    ...
                    break;
                default:
                    b.left = n.left + g.offsetLeft + "px", b.top = n.top + d.getHeight(e) + g.offsetTop - f + "px"
            }
    ...
    var F = function(a) {
        ...
        a.publish = function(a, d, f) {
            for (var g = (a = b[a]) ? a.length : 0, k; g--;)
                if (k = a[g].apply(d, f || []), "boolean" === typeof k) return k
        };
    ...
    (function(a) {
        ...
        function r(c, s, a, b) {
            ...
            if (d || s) f = c.minute(), g = c.hour();
            d && c.date(c.date() + d * a);
            s && c.month(c.month() + s * a);
            e && !b && h.updateOffset(c);
            if (d || s) c.minute(f), c.hour(g)
        }
        ...
        function G(c) {
            ...
            for (e = 0; e < a.length; e++)
                if ((d = (D(a[e], c).exec(b) || [])[0]) && (b = b.slice(b.indexOf(d) + d.length)), x[a[e]]) {
                    var f = c,
                        h = void 0,
                        g = f._a;
                    switch (a[e]) {
                        ...
                        case "Z":
                        case "ZZ":
                            f._useUTC = !0, f._tzm = C(d)
                    }
                    null == d && (f._isValid = !1)
                }
            b && (c._il = b);
            c._isPm && 12 > c._a[3] && (c._a[3] += 12);
            !1 === c._isPm && 12 === c._a[3] && (c._a[3] = 0);
            L(c)
        }
        ...
        function P(c) {
            ...
            if (h.isMoment(b)) c = k({}, b), c._d = new Date(+b._d);
            else if (d)
                if ("[object Array]" === Object.prototype.toString.call(d)) {
                    var b = c,
                        e, g, l = 99,
                        m;
                    for (m = 0; m < b._f.length; m++) e = k({}, b),
                        e._f = b._f[m], G(e), d = new f(e), e = v(e._a, d.toArray()), d._il && (e += d._il.length), e < l && (l = e, g = d);
                    k(b, g)
                } else G(c);
            else if (g = c, b = g._i, d = fa.exec(b), b === a) g._d = new Date;
            else if (d) g._d = new Date(+d[1]);
            else if ("string" === typeof b)
                if (b = g._i, d = ga.exec(b)) {
                    g._f = "YYYY-MM-DD" + (d[2] || " ");
                    for (d = 0; 4 > d; d++)
                        if (Q[d][1].exec(b)) {
                            g._f += Q[d][0];
        ...
        for (var h, y = Math.round, t, A = {}, M = "undefined" !== typeof module && module.exports, fa = /^\/?Date\((\-?\d+)/i, ia = /(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/, N = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,
                O = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, da = /\d\d?/, Z = /\d{1,3}/, W = /\d{3}/, X = /\d{1,4}/, Y = /[+\-]?\d{1,6}/, aa = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, I = /Z|[\+\-]\d\d:?\d\d/i, ca = /T/i, ba = /[\+\-]?\d+(\.\d{1,3})?/, ga = /^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/, Q = [
                    ["HH:mm:ss.S", /(T| )\d\d:\d\d:\d\d\.\d{1,3}/],
                    ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/],
                    ["HH:mm", /(T| )\d\d:\d\d/],
                    ["HH", /(T| )\d\d/]
                ],
                ea = /([\+\-]|\d\d)/gi, J = ["Date", "Hours", "Minutes", "Seconds", "Milliseconds"], K = {
                    Milliseconds: 1,
                    Seconds: 1E3,
                    Minutes: 6E4,
                    Hours: 36E5,
                    ...
                    M: "month",
                    y: "year"
                }, H = {}, T = "DDD w W M D d".split(" "), U = "MDHhmswW".split(""), x = {
                    M: function() {
                        return this.month() + 1
                    },
                    MMM: function(c) {
                ...
                }; T.length;) t = T.pop(), x[t + "o"] = e(x[t], t);
        ...
        d.prototype = {
            set: function(c) {
                var a, b;
                for (b in c) a = c[b], "function" === typeof a ? this[b] = a : this["_" + b] = a
            },
            _months: "一月 二月 三月 四月 五月 六月 七月 八月 九月 十月 十一月 十二月".split(" "),
            months: function(c) {
                return this._months[c.month()]
            },
            _monthsShort: "一 二 三 四 五 六 七 八 九 十 十一 十二".split(" "),
            ...
            monthsParse: function(c) {
                ...
                for (a = 0; 12 > a; a++)
                    if (this._monthsParse[a] || (b = h([2E3, a]), b = "^" + this.months(b, "") + "|^" + this.monthsShort(b, ""), this._monthsParse[a] = RegExp(b.replace(".", ""), "i")), this._monthsParse[a].test(c)) return a
            },
            _weekdays: "周日 周一 周二 周三 周四 周五 周六".split(" "),
            weekdays: function(c) {
                return this._weekdays[c.day()]
            },
            _weekdaysShort: "日 一 二 三 四 五 六".split(" "),
            weekdaysShort: function(c) {
                return this._weekdaysShort[c.day()]
            },
            _weekdaysMin: "日 一 二 三 四 五 六".split(" "),
            ...
            weekdaysParse: function(c) {
                ...
                for (a = 0; 7 > a; a++)
                    if (this._weekdaysParse[a] || (b = h([2E3, 1]).day(a), b = "^" + this.weekdays(b, "") + "|^" + this.weekdaysShort(b, "") + "|^" + this.weekdaysMin(b, ""), this._weekdaysParse[a] = RegExp(b.replace(".", ""), "i")), this._weekdaysParse[a].test(c)) return a
            },
            _longDateFormat: {
                LT: "h:mm A",
                L: "MM/DD/YYYY",
            ...
            longDateFormat: function(c) {
                var a = this._longDateFormat[c];
                !a && this._longDateFormat[c.toUpperCase()] && (a = this._longDateFormat[c.toUpperCase()].replace(/MMMM|MM|DD|dddd/g, function(c) {
                    return c.slice(1)
        ...
        h.fn = f.prototype = {
            ...
            zone: function(a) {
                ...
                if (null != a) "string" === typeof a && (a = C(a)), 16 > Math.abs(a) && (a *= 60), this._offset = a, this._isUTC = !0, b !== a && r(this, h.duration(b - a, "m"), 1, !0);
    ...
    if (!r.moment)
        if (window.moment) r.moment = window.moment;
